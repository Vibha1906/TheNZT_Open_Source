...
from src.ai.tools.web_search_tools import tool_list
from src.ai.agent_prompts.web_search_agent import SYSTEM_PROMPT
...
class WebSearchAgent(BaseAgent):
    def __init__(self):
        super().__init__()
        self.model = get_llm(wsc.MODEL, wsc.TEMPERATURE)
